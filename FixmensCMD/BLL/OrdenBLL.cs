...
namespace FixmensCMD.BLL
{
    public class OrdenBLL
    {
        public List<REPARACIONESVIEW> GetReparaciones()
        {
            ...
            cmd.CommandText = "SELECT R.CODIGO, a.MARCA || ' - ' || a.MODELO as EQUIPO, C.NOMBRES || ' ' || C.telefono || ' ' || C.celular as NOMBRES,R.FALLA,R.INFORMETALLER,P.DETALLE, P.PRESUPUESTO, I.NOMBRES AS TECNICO, R.FECHAINGRESO,R.PROMETIDO,R.FECHATERMINADO, ESTADO.NOMBRE ESTADO " +
